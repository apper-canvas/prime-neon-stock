  ...
  return (
    <div className="relative">
      <select
        ref={ref}
        className={cn(
          "flex h-12 w-full rounded-lg glass px-4 py-3 text-white transition-all duration-300 appearance-none bg-no-repeat bg-right bg-[length:16px_16px] pr-10",
      ...
      {label && (
        <label className={cn(
          "absolute left-4 -top-2 text-xs text-white/70 bg-slate-900 px-2 pointer-events-none",
